                ...
                <section>
                    <div className="relative mx-auto max-w-6xl px-6 pt-32 lg:pb-16 lg:pt-48">
                        <div className="relative z-10 mx-auto max-w-4xl text-center">
                            ...
                            >
                                <h1
                                    className="text-balance text-4xl font-medium sm:text-5xl md:text-6xl text-text-primary">
                                ...
                                <form
                                    ...
                                    <div className="bg-background has-[input:focus]:ring-accent-cyan relative grid grid-cols-[1fr_auto] pr-1.5 items-center rounded-[1rem] border border-borderline shadow shadow-zinc-950/5 has-[input:focus]:ring-2 lg:pr-0">
                                        <Mail className="pointer-events-none absolute inset-y-0 left-4 my-auto size-4 text-text-secondary" />

                                        <input
                                            placeholder="Your mail address"
                                            className="h-12 w-full bg-transparent pl-12 focus:outline-none text-text-primary placeholder:text-text-muted"
                                            type="email"
                                        />
                                        ...
                                        <div className="md:pr-1.5 lg:pr-0">
                                            <Button
                                                aria-label="submit"
                                                size="sm"
                                                className="rounded-[0.5rem] mt-1 lg:mt-0 mb-1 lg:mb-0">
                                ...
                                <div
                                    aria-hidden
                                    className="bg-[radial-gradient(circle_at_center,theme(colors.accent-cyan/0.2),transparent_55%)] relative mx-auto mt-32 max-w-2xl text-left"
                                >
                                    <div className="bg-background border-borderline absolute inset-0 mx-auto w-80 -translate-x-3 -translate-y-12 rounded-[2rem] border p-2 [mask-image:linear-gradient(to_bottom,#000_50%,transparent_90%)] sm:-translate-x-6">
                                        <div className="relative h-96 overflow-hidden rounded-[1.5rem] border border-borderline/50 p-2 pb-12 before:absolute before:inset-0 before:bg-[repeating-linear-gradient(-45deg,theme(colors.borderline),theme(colors.borderline)_1px,transparent_1px,transparent_6px)] before:opacity-50"></div>
                                    </div>
                                    <div className="bg-card-bg/50 border-borderline mx-auto w-80 translate-x-4 rounded-[2rem] border p-2 backdrop-blur-3xl [mask-image:linear-gradient(to_bottom,#000_50%,transparent_90%)] sm:translate-x-8">
                                        <div className="bg-card-bg space-y-2 overflow-hidden rounded-[1.5rem] border border-borderline p-2 shadow-xl shadow-black backdrop-blur-3xl">
                                            <AppComponent />

                                            <div className="bg-background/50 rounded-[1rem] p-4 pb-16"></div>
                                        </div>
                                    </div>
                                    <div className="absolute inset-0 bg-[radial-gradient(#1A2D45_1px,transparent_1px)] mix-blend-overlay [background-size:16px_16px] [mask-image:radial-gradient(ellipse_50%_50%_at_50%_50%,#000_70%,transparent_100%)] opacity-30" />
                                </div>
                            </AnimatedGroup>
                        </div>
                    </div>
    ...
    return (
        <div className="relative space-y-3 rounded-[1rem] bg-white/5 p-4">
            ...
            <div className="space-y-3">
                <div className="text-text-primary border-b border-borderline pb-3 text-sm font-medium">This year, you&apos;re walking more on average than you did in 2023.</div>
                <div className="space-y-3">
                    <div className="space-y-1">
                        <div className="space-x-1">
                            <span className="text-text-primary align-baseline text-xl font-medium">8,081</span>
                            <span className="text-text-muted text-xs">Steps/day</span>
                        </div>
                        <div className="flex h-5 items-center rounded bg-gradient-to-l from-accent-cyan to-blue-600 px-2 text-xs text-background">2024</div>
                    </div>
                    <div className="space-y-1">
                        <div className="space-x-1">
                            <span className="text-text-primary align-baseline text-xl font-medium">5,412</span>
                            <span className="text-text-muted text-xs">Steps/day</span>
                        </div>
                        <div className="text-text-primary bg-card-bg/50 flex h-5 w-2/3 items-center rounded px-2 text-xs">2023</div>
                    </div>
                </div>
            </div>
        </div>
    ...
    return (
        <header>
            <nav
                ...
                <div className={cn('mx-auto mt-2 max-w-6xl px-6 transition-all duration-300 lg:px-12', isScrolled && 'bg-background/80 max-w-4xl rounded-2xl border border-borderline backdrop-blur-lg lg:px-5')}>
                    <div className="relative flex flex-wrap items-center justify-between gap-6 py-3 lg:gap-0 lg:py-4">
                        <div className="flex w-full justify-between lg:w-auto">
                            ...
                            <button
                                ...
                                className="relative z-20 -m-2.5 -mr-4 block cursor-pointer p-2.5 lg:hidden text-text-primary">
                            ...
                            <ul className="flex gap-8 text-sm">
                                {menuItems.map((item, index) => (
                                    <li key={index}>
                                        <Link
                                            href={item.href}
                                            className="text-text-secondary hover:text-accent-cyan block duration-150">
                                            <span>{item.name}</span>
                                        </Link>
                                    </li>
                                ))}
                        ...
                        <div className="bg-background group-data-[state=active]:block lg:group-data-[state=active]:flex mb-6 hidden w-full flex-wrap items-center justify-end space-y-8 rounded-3xl border border-borderline p-6 shadow-2xl shadow-black/20 md:flex-nowrap lg:m-0 lg:flex lg:w-fit lg:gap-6 lg:space-y-0 lg:border-transparent lg:bg-transparent lg:p-0 lg:shadow-none dark:shadow-none dark:lg:bg-transparent">
                            ...
                            <div className="flex w-full flex-col space-y-3 sm:flex-row sm:gap-3 sm:space-y-0 md:w-fit">
                                <Button
                                    ...
                                    variant="outline"
                                    size="sm"
                                    className={cn(isScrolled && 'lg:hidden', "text-text-primary")}>
                                    <Link href="#">
                                        <span>Login</span>
                                    </Link>
                                </Button>
...
const LogoCloud = () => {
    return (
        <section className="bg-transparent pb-16 md:pb-32 mt-10">
            <div className="group relative m-auto max-w-6xl px-6">
                <div className="flex flex-col items-center md:flex-row">
                    <div className="inline md:max-w-44 md:border-r border-borderline md:pr-6 mb-8 md:mb-0">
                        <p className="text-center md:text-end text-sm text-text-secondary uppercase tracking-widest font-mono">Powered By</p>
                    </div>
                    <div className="relative py-6 md:w-[calc(100%-11rem)] border-y border-borderline/30 bg-card-bg/10 backdrop-blur-sm">
                        <InfiniteSlider
                            durationOnHover={20}
                            duration={40}
                            gap={112}>
                            <div className="flex">
                                <img
                                    className="mx-auto h-5 w-fit invert opacity-70 hover:opacity-100 transition-opacity"
                            ...
                            <div className="flex">
                                <img
                                    className="mx-auto h-4 w-fit invert opacity-70 hover:opacity-100 transition-opacity"
                            ...
                            <div className="flex">
                                <img
                                    className="mx-auto h-7 w-fit invert opacity-70 hover:opacity-100 transition-opacity"
                            ...
                            <div className="flex">
                                <img
                                    className="mx-auto h-6 w-fit invert opacity-70 hover:opacity-100 transition-opacity"
